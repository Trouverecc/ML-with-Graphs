...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    #改路径
    torch.save(best_model_wts, 'D:/pythonProject/Pytorch-try/VGG16/best_model.pth')
...
if __name__=="__main__":
    ...
    train_process = train_model_process(VGG16, train_dataloader, val_dataloader,20)#20轮
