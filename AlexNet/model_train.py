...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    torch.save(best_model_wts, 'D:/pythonProject/Pytorch-try/AlexNet/best_model.pth')
...
if __name__=="__main__":
    ...
    train_process = train_model_process(AlexNet, train_dataloader, val_dataloader,20)#20轮
